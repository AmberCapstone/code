...
#define USBD_MANUFACTURER_STRING "amber"
#define USBD_PRODUCT_STRING "Sensor Board"
...
__ALIGN_BEGIN uint8_t USBD_BOSDesc[USB_SIZ_BOS_DESC] __ALIGN_END = {
    ...
    USBD_BB_URL_STRING_INDEX, /* iAddtionalInfoURL: Index of string descriptor
                                 providing a URL where the user can go to get
                                 more detailed information about the product and
                                 the various Alternate Modes it supports */
    ...
    0x00,
    0x00, /* VCONN Power needed by the adapter for full functionality 000b = 1W
           */

    0x01,
    0x00,
    0x00,
    0x00, /* bmConfigured. 01b: Alternate Mode configuration not attempted or
             exited */
    0x00,
    0x00,
    0x00,
    ...
    USBD_BB_ALTMODE1_STRING_INDEX, /* iAlternateModeString[1]: Index of string
                                    descriptor describing protocol. It is
                                    optional to support this string. */
    /* Alternate Mode Desc */
    ...
    0x00,
    0x00,
    0x00, /* dwAlternateModeVdo: contents of the Mode VDO for the alternate mode
