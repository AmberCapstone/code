...
#define HSI48_VALUE                                                           \
    48000000U /*!< Value of the Internal High Speed oscillator for USB FS/RNG \
...
#define TICK_INT_PRIORITY \
    (3U) /*!< tick interrupt priority (lowest by default) */
#define USE_RTOS 0U
...
#define USE_HAL_LCD_REGISTER_CALLBACKS \
    0U /* LCD register callback disabled      */
