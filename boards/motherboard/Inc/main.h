...
#define BACKSCATTER_READ_Pin GPIO_PIN_5
#define BACKSCATTER_READ_GPIO_Port GPIOC
...
#define P6V_HSD_ONE_DIAG_EN_Pin GPIO_PIN_6
#define P6V_HSD_ONE_DIAG_EN_GPIO_Port GPIOD
