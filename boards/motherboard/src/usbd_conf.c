...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef* pdev) {
    ...
    HAL_PCD_RegisterCallback(&hpcd_USB_DRD_FS, HAL_PCD_SOF_CB_ID,
                             PCD_SOFCallback);
    HAL_PCD_RegisterCallback(&hpcd_USB_DRD_FS, HAL_PCD_SETUPSTAGE_CB_ID,
                             PCD_SetupStageCallback);
    HAL_PCD_RegisterCallback(&hpcd_USB_DRD_FS, HAL_PCD_RESET_CB_ID,
                             PCD_ResetCallback);
    HAL_PCD_RegisterCallback(&hpcd_USB_DRD_FS, HAL_PCD_SUSPEND_CB_ID,
                             PCD_SuspendCallback);
    HAL_PCD_RegisterCallback(&hpcd_USB_DRD_FS, HAL_PCD_RESUME_CB_ID,
                             PCD_ResumeCallback);
    HAL_PCD_RegisterCallback(&hpcd_USB_DRD_FS, HAL_PCD_CONNECT_CB_ID,
                             PCD_ConnectCallback);
    HAL_PCD_RegisterCallback(&hpcd_USB_DRD_FS, HAL_PCD_DISCONNECT_CB_ID,
    ...
    HAL_PCD_RegisterDataOutStageCallback(&hpcd_USB_DRD_FS,
                                         PCD_DataOutStageCallback);
    HAL_PCD_RegisterDataInStageCallback(&hpcd_USB_DRD_FS,
                                        PCD_DataInStageCallback);
    HAL_PCD_RegisterIsoOutIncpltCallback(&hpcd_USB_DRD_FS,
                                         PCD_ISOOUTIncompleteCallback);
    HAL_PCD_RegisterIsoInIncpltCallback(&hpcd_USB_DRD_FS,
